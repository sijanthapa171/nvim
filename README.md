...
**To install on windows, delete your nvim folder in %USERPROFILE%\appdata\local\ if you have one there. Then run: ```Shell git clone https://github.com/sijanthapa171/nvim.git "%USERPROFILE%\appdata\local\nvim"```**
